...
filemtime('C:\wamp\www\df/modules/user/templates/inscription.tpl') > 1440889062){ return false;
} else {
function template_meta_6183639f8b66535dbed8309516f5de85($t){
$t->meta('link~header');
$t->meta('link~footer');

}
function template_6183639f8b66535dbed8309516f5de85($t){
?><?php $t->display('link~header');?>
