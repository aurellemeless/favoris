...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="<?php echo BASEPATH; ?>styles/df/css/font-awesome/css/font-awesome.css">
	<link rel="stylesheet" href="<?php echo BASEPATH; ?>styles/df/css/bootstrap.css">
	<link rel="stylesheet" href="<?php echo BASEPATH; ?>styles/df/js/slick/slick.css"/>
	<link rel="stylesheet" href="<?php echo BASEPATH; ?>styles/df/js/flex-slider/flexslider.css"/>
	<link rel="stylesheet" href="<?php echo BASEPATH; ?>styles/df/js/owl-carousel/owl.carousel.css"/>
	<link rel="stylesheet" href="<?php echo BASEPATH; ?>styles/df/js/owl-carousel/owl.theme.css"/>
	<link rel="stylesheet" href="<?php echo BASEPATH; ?>styles/df/js/owl-carousel/owl.transitions.css"/>
	<link rel="stylesheet" href="<?php echo BASEPATH; ?>styles/df/css/prettyphoto.css">
	<link rel="stylesheet" href="<?php echo BASEPATH; ?>styles/df/css/style.css">

	<!-- SKIN -->
	<link rel="stylesheet" title="blue" href="<?php echo BASEPATH; ?>styles/df/css/colors/skin-blue.css"/>
	...
	<!-- MODERNIZR -->
	<script src="<?php echo BASEPATH; ?>styles/df/js/modernizr.custom.js"></script>
...
<!-- Javascript -->
<script src="<?php echo BASEPATH; ?>styles/df/js/jquery.js"></script>
<script src="<?php echo BASEPATH; ?>styles/df/js/bootstrap.min.js"></script>
<script src="<?php echo BASEPATH; ?>styles/df/js/jquery.easing.min.js"></script>
...
<script src="<?php echo BASEPATH; ?>styles/df/js/mc/jquery.ketchup.all.min.js"></script>
<script src="<?php echo BASEPATH; ?>styles/df/js/mc/main.js"></script>
<script src="<?php echo BASEPATH; ?>styles/df/js/jquery.countdown.min.js"></script>
<script src="<?php echo BASEPATH; ?>styles/df/js/main.js"></script>
