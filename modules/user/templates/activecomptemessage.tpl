		...
		<div class="row">
			...
			<div class="col-lg-12">
                            ...
                            <div class="panel">
                                ...
                                <div id="titre">
                                    <h3> <i class="glyphicon glyphicon-share-alt"></i> Activation de compte..</h3>  
                                    <div class="progress">
                                      <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 100%; height:7px !important;">
                                      </div>
                                    </div>
                                </div>
