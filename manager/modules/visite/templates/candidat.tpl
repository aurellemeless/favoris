...
<div class="col-md-12">
    ...
    <a  href="#/candidat/{{ candidat.id }}"  ng-show="!list" title="Modifier le resultat" class="btn btn-warning">
                                ...
                                <tbody>
                                    <tr ng-repeat="row in $data">
                                        ...
                                        <td>
                                            ...
                                            {/literal}{ifright 'visite.candidat.edit'}{literal}
                                            <a  href="#/candidat/{{ row.id }}" title="Modifier le resultat" class="btn btn-warning">
                                                <span class="glyphicon glyphicon-pencil"></span> Modifier
                                            </a>
                                            {/literal}{/ifright}{literal}
                                        </td>
