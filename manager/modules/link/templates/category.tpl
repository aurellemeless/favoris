        ...
        <h4 ng-if="operation.success==false" class="alert alert-danger">{{operation.msg}}</h4>
            --> <div class="col-md-6">
                <div class="">
                  ...
                  <br/><br/>
                    <fieldset><legend> <span class="glyphicon glyphicon-category"> </span> Zone </legend>
                       ...
                       <div class="row">
                           <div class="col-xs-8 form-group">
                               ...
                               <textarea ng-model="category.description" name="description"  class="form-control" id="description_category" placeholder="brève description de la catégorie">
                               </textarea>
                           </div>
                       </div>
                       <div class="row">
