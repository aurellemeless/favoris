...
angular.module('bos')
        .controller('LinkCategoryController',['$scope','$http','$filter', '$q', 'ngTableParams',function($scope, $http, $filter, $q, ngTableParams){
                
                var saveurl=APPBASE+'index.php?module=moneyos&action=category:save';
                $scope.list = true;
                //
                $scope.category = {};
                ...
                $scope.delete = function (id) {
                    $http.get(APPBASE + 'index.php?module=moneyos&action=category:delete&id='+id)
                            .success(function (d) {
                                    if(d.success){
                ...
                $scope.trash = function(id){
                    ...
                    if(confirm(TRASH_CONFIRM)){
                        $http.get(APPBASE + 'index.php?module=moneyos&action=category:trash&id='+id)
                            .success(function (d) {
                                    if(d.success){
                                        toastr.success(d.msg,OP_GOOD);
                                    }else{
               ...
               $scope.tableParams = new ngTableParams({
                    ...
                    getData: function($defer, params) {
                        //console.log(start);
                        $http.get(APPBASE + 'index.php?module=moneyos&action=category:read',{params : params.$params})
