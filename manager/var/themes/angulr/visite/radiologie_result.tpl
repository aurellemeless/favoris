                    ...
                    <fieldset><legend> <span class="glyphicon glyphicon-group"> </span>RESULTAT : RADIO POUMON FACE </legend>
                       ...
                       <div class="row">
                           <div class="col-xs-8 form-group">
                               <label for="creatinine_radiologie"> Interpretation : </label>
                               <span> {{radiologie.radio}} </span>
                           </div>
                       </div>
...
<div ng-show="list" class="col-md-12">
           ...
           <div class="panel panel-default">
              <div class="panel-heading font-bold">RADIOLOGIE : Liste des resultats ( {{ total}})</div>
                <div class="panel-body">
                            ...
                            <table  ng-table="tableParams" show-filter="true"  class="table  table-bordered table-hover ng-table-responsive">
                                ...
                                <tbody>
                                    <tr ng-repeat="row in $data">
                                        ...
                                        <td>
                                            <button type="button" ng-click="edit($index)" title="Voir le resultat" class="btn btn-success">
