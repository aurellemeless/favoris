...
<div class="bg-light lter b-b wrapper-md">
  <h1 class="m-n font-thin h3"> Gestion desExamens de laboratoire </h1>
</div>
                    ...
                    <fieldset><legend> <span class="glyphicon glyphicon-group"> </span>RESULTAT : BIOCHIMIE SANGUINE </legend>
                       ...
                       <div class="row">
                           <div class="col-xs-8 form-group">
                               ...
                               <span> {{laboratoire.creatinine}} </span>
                           </div>
                       </div>
...
<div ng-show="list" class="col-md-12">
                   ...
                   <div class="panel panel-default">
          <div class="panel-heading font-bold"> LABORATOIRE : Liste des resultats ( {{ total}}) </div>
            <div class="panel-body">
