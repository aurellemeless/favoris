                  ...
                  <br/><br/>
                    <fieldset>
                     ...
                     <fieldset><legend> <span class="glyphicon glyphicon-group"> </span>RESULTAT : RADIOLOGIE </legend>
                       ...
                       <div class="row">
                           <div class="col-xs-8 form-group">
                               <button type="button" ng-disabled="form_candidat.$invalid" ng-click="save(form_candidat,true);" name="ok" class="btn btn-success">Enregistrer</button>
                               
                               <a href="#/candidat" class="btn btn-danger">Quitter</a>
                               <br/><br/>
                           </div>
                       </div>
                     </fieldset>
